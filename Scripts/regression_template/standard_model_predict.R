...
#   }
  ...
  dtree_mse <- mean((dtree.predictions - test.ground_truth))^2
...
#     , test_stats = dtree.test_stats
  ...
  test.net_mse <- mean((elasticNet.predictions - ground_truth[partition[[run_ind]]$test_index]))^2
...
#     , alpha = elastic_net.ALPHA[temp.best_alpha_index] 
  ...
  test.lass_mse <- mean((lasso.predictions - test.ground_truth))^2
#test.ground_truth_1inN <- class.ind(ground_truth[partition[[run_ind]]$test_index])
...
#     , test_stats = lasso.test_stats
  ...
  test.ground_truth <- ground_truth[partition[[run_ind]]$test_index]
  test.ridge_mse <- mean((ridge.predictions - test.ground_truth))^2
  #test.ground_truth_1inN <- class.ind(ground_truth[partition[[run_ind]]$test_index])
...
#   }
  ...
  test.ground_truth <- ground_truth[partition[[run_ind]]$test_index]
  test.rf_mse <- mean((rf.predictions - test.ground_truth))^2
  #test.ground_truth_1inN <- class.ind(ground_truth[partition[[run_ind]]$test_index])
...
#     , test_stats = rf.test_stats
  ...
  test.ground_truth <- ground_truth[partition[[run_ind]]$test_index]
  test.svm_mse <- mean((svmLinear.predictions - test.ground_truth))^2
#   test.ground_truth_1inN <- class.ind(ground_truth[partition[[run_ind]]$test_index])
...
#     , test_stats = svmLinear.test_stats
  ...
  test.ground_truth <- ground_truth[partition[[run_ind]]$test_index]
  test.svm_radial_mse <- mean((svmRadial.predictions - test.ground_truth))^2
#   test.ground_truth_1inN <- class.ind(ground_truth[partition[[run_ind]]$test_index])
