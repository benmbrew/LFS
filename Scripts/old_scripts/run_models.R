...
# read cases 
raw_cases <- readRDS(paste0(model_data, '/raw_cases_batch.rda'))
swan_cases <- readRDS(paste0(model_data, '/swan_cases_batch.rda'))
quan_cases <- readRDS(paste0(model_data, '/quan_cases_batch.rda'))
funnorm_cases <- readRDS(paste0(model_data, '/funnorm_cases_batch.rda'))

# bh_features
load(paste0(model_data, 'bh_feat_new.RData'))
