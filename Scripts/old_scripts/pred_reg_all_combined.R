...
betaFullCon <- betaFullCon[, 1:100000]
...
con_pred_age_final_1  <- as.data.frame(cbind(con_pred_age_final_1, c(seq(1, 32, 1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1))))
...
# get mean across folds - sets of 30 by 5
con_real_age_final_1  <- as.data.frame(cbind(con_real_age_final_1, c(seq(1, 32, 1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1), 
                                                                     seq(1, 32,1))))
...
# plot
plot(con_real_final$mean_x, con_pred_final$mean_x, xlim = c(0, 200), ylim = c(0, 200))
abline(0, 1)
cor(con_real_final$mean_x, con_pred_final$mean_x)

# plot
plot(case_pred_age_final_1, case_real_age_final_1, xlim = c(0, 800), ylim = c(0, 800))
abline(0, 1)
