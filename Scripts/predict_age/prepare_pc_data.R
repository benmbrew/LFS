...
saveRDS(cases_450_small, paste0('../../Data/', method,'/cases_450_small_', combat,'.rda'))
saveRDS(cases_850_small, paste0('../../Data/', method,'/cases_850_small_', combat,'.rda'))
saveRDS(con_mut_small, paste0('../../Data/', method,'/con_mut_small_', combat,'.rda'))
saveRDS(con_850_small, paste0('../../Data/', method,'/con_850_small_', combat,'.rda'))
saveRDS(con_wt_small, paste0('../../Data/', method,'/con_wt_small_', combat,'.rda'))

saveRDS(cases_450, paste0('../../Data/', method,'/cases_450_', combat,'.rda'))
saveRDS(cases_850, paste0('../../Data/', method,'/cases_850_', combat,'.rda'))
saveRDS(con_mut, paste0('../../Data/', method,'/con_mut_', combat,'.rda'))
