...
plot_pc <- function(temp_dat, 
  ...
  temp_dat$age_fac <- ifelse(temp_dat$age_sample_collection > 0 &
                                temp_dat$age_sample_collection <= 36, 'first_age', 
                              ifelse(temp_dat$age_sample_collection > 36 &
                                       temp_dat$age_sample_collection <= 348, 'second_age','third_age'))
...
# run combat on age
cases_450 <- run_combat(cases_450, type = 'age')
cases_850 <- run_combat(cases_850, type = 'age')
con_450 <- run_combat(con_450, type = 'age')
con_850 <- run_combat(con_850, type = 'age')
con_wt <- run_combat(con_wt, type = 'age')
...
saveRDS(cases_450, paste0('../../Data/', method,'/cases_450_age_combat_', combat,'.rda'))
saveRDS(cases_850, paste0('../../Data/', method,'/cases_850_age_combat_', combat,'.rda'))
saveRDS(con_450, paste0('../../Data/', method,'/con_450_age_combat_', combat,'.rda'))
saveRDS(con_850, paste0('../../Data/', method,'/con_850_age_combat_', combat,'.rda'))
saveRDS(con_wt, paste0('../../Data/', method,'/con_wt_age_combat_', combat,'.rda'))
