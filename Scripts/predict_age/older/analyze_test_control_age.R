...
if(model_type == 'enet' | model_type == 'lasso'){
  # read in cases_450
  temp_con <- readRDS(paste0('data_test/', 'con_test_age',method,'_',size,'_',is_gen,'_',combat,'_', model_type,'.rda'))
  
  temp_valid <- readRDS(paste0('data_test/', 'valid_test_age',method,'_',size,'_',is_gen, '_',combat, '_', model_type,'.rda'))
  ...
  temp_con <- readRDS(paste0('data_test/', 'con_test_control_age', method,'_',size,'_',is_gen,'_',combat,'_', model_type,'.rda'))
  
  temp_valid <- readRDS(paste0('data_test/', 'valid_test_control_age',method,'_',size,'_',is_gen,'_',combat,'_', model_type,'.rda'))
  
  temp_importance <- readRDS(paste0('data_test/', 'importance_control_age',method,'_',size,'_',is_gen,'_',combat,'_', model_type,'.rda'))
