...
##########
# load all data
load(paste0(model_data, '/modal_feat_surv_10.RData'))
...
##########
# ff
surv_ff_10_all <- getRun(ff_feat_all, .10)
surv_ff_10_sig <- getRun(ff_feat_sig, .10)
surv_ff_10_fwer <- getRun(ff_feat_fwer, .10)

# fs
surv_fs_10_all <- getRun(fs_feat_all, .10)
surv_fs_10_sig <- getRun(fs_feat_sig, .10)
surv_fs_10_fwer <- getRun(fs_feat_fwer, .10)

# sf
surv_sf_10_all <- getRun(sf_feat_all, .10)
surv_sf_10_sig <- getRun(sf_feat_sig, .10)
surv_sf_10_fwer <- getRun(sf_feat_fwer, .10)

# ss
surv_ss_10_all <- getRun(ss_feat_all, .10)
surv_ss_10_sig <- getRun(ss_feat_sig, .10)
surv_ss_10_fwer <- getRun(ss_feat_fwer, .10)
...
save.image('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/surv_10.RData')
# load('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/surv_10.RData')
