...
##########
# load all data
load(paste0(model_data, '/modal_feat_pred_10.RData'))
...
##########
# bal_feat
pred_bal_10_all <- getRun(bal_feat_all, .10)
pred_bal_10_sig <- getRun(bal_feat_sig, .10)
pred_bal_10_fwer <- getRun(bal_feat_fwer, .10)

# bal_feat
pred_bal_full_10_all <- getRun(bal_full_feat_all, .10)
pred_bal_full_10_sig <- getRun(bal_full_feat_sig, .10)
pred_bal_full_10_fwer <- getRun(bal_full_feat_fwer, .10)
...
# save.image('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/pred_10.RData')
# load('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/pred_10.RData')
