...
##########
# load all data
load(paste0(model_data, '/modal_feat_surv_30.RData'))
...
##########
# ff
surv_ff_30_all <- getRun(ff_feat_all, .30)
surv_ff_30_sig <- getRun(ff_feat_sig, .30)
surv_ff_30_fwer <- getRun(ff_feat_fwer, .30)

# fs
surv_fs_30_all <- getRun(fs_feat_all, .30)
surv_fs_30_sig <- getRun(fs_feat_sig, .30)
surv_fs_30_fwer <- getRun(fs_feat_fwer, .30)

# sf
surv_sf_30_all <- getRun(sf_feat_all, .30)
surv_sf_30_sig <- getRun(sf_feat_sig, .30)
surv_sf_30_fwer <- getRun(sf_feat_fwer, .30)

# ss
surv_ss_30_all <- getRun(ss_feat_all, .30)
surv_ss_30_sig <- getRun(ss_feat_sig, .30)
surv_ss_30_fwer <- getRun(ss_feat_fwer, .30)
...
# save.image('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/surv_30.RData')
# load('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/surv_30.RData')
