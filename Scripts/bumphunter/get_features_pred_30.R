...
##########
# load all data
load(paste0(model_data, '/modal_feat_pred_30.RData'))
...
##########
# bal_feat
pred_bal_30_all <- getRun(bal_feat_all, .30)
pred_bal_30_sig <- getRun(bal_feat_sig, .30)
pred_bal_30_fwer <- getRun(bal_feat_fwer, .30)

# bal_feat
pred_bal_full_30_all <- getRun(bal_full_feat_all, .30)
pred_bal_full_30_sig <- getRun(bal_full_feat_sig, .30)
pred_bal_full_30_fwer <- getRun(bal_full_feat_fwer, .30)
...
# save.image('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/pred_30.RData')
# load('/home/benbrew/hpf/largeprojects/agoldenb/ben/Projects/LFS/Data/model_data/pred_30.RData')
