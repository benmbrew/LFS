...
if(model_type == 'enet'){
  ...
  # read in cases_450
  saveRDS(temp_con, paste0('age_combat_data_test_train_control/', 'con_test', method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  
  saveRDS(temp_valid, paste0('age_combat_data_test_train_control/', 'valid_test',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  ...
  saveRDS(temp_con, paste0('age_combat_data_test_train_control/', 'con_test_pc_2',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  
  saveRDS(temp_valid, paste0('age_combat_data_test_train_control/', 'valid_test_pc_2',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  
  saveRDS(temp_importance, paste0('age_combat_data_test_train_control/', 'importance_pc_2',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
