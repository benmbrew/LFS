...
if(model_type == 'enet'){
  ...
  saveRDS(temp_con, paste0('age_combat_data_test_train_control/', 'con_test_pc',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  
  saveRDS(temp_valid, paste0('age_combat_data_test_train_control/', 'valid_test_pc',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
  
  saveRDS(temp_importance, paste0('age_combat_data_test_train_control/', 'importance_pc',method,'_',size,'_',is_gen, '_',combat,'_', model_type,'.rda'))
